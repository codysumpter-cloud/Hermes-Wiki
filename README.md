...
- [2026-05-13-update](changelog/2026-05-13-update.md): 595 commits (v0.12.0 → v0.13.0)，Teams/LINE/Google Chat 三新平台、Curator archive/prune/backup/rollback、per-turn file-mutation verifier、LSP 语义诊断、cross-session 1h prompt cache、`/handoff`、Telegram `/topic`、Piper TTS + 命令型 provider、i18n 16 语种、`ctx.llm` 插件 LLM 访问、kanban hardening、supply-chain advisory checker
