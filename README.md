...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Changelogs-33-blueviolet?style=for-the-badge" alt="Changelogs" height="28">
  <img src="https://img.shields.io/badge/Version-v0.15.1_(eb3cf975)-purple?style=for-the-badge" alt="Version" height="28">
...
### 更新日志（33 个，最新优先 — 完整列表见 [index.md](index.md)）
...
- **更新日志**: 33 个
- **源码覆盖**: 关键模块逐行验证
- **跟踪版本**: v0.15.1（hermes-agent/main HEAD `eb3cf9750`，2026-05-31 12:13 -0700）
- **最后更新**: 2026-05-31
